...
import { useAppConfig, useDexKitContext, useLocale, useThemeMode } from "@dexkit/ui/hooks";
import {
  appMetadata,
  client,
  wallets,
...
export const useWalletConnect = () => {
  ...
  const connectWallet = async () => {
    ...
    try {
      ...
      console.error("Error connecting wallet:", error as Error);
    }
  };

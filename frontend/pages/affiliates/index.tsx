...
const AffiliatesPage: NextPage = () => {
  ...
  const handleShareContentGame = (value: string) => {
    const msg = formatMessage(
      {
        id: 'share.affiliate.message',
        defaultMessage: 'Join Coinlympia! Best prediction game. Use my referral link: {url}',
      },
      { url: affiliateUrl }
    );
      ...
      <Stack spacing={2}>
        <AppPageHeader
          breadcrumbs={[
            ...
            {
              caption: (
                <FormattedMessage id="affiliate" defaultMessage="Affiliate Program" />
              ),
              uri: '/affiliate',
              active: true,
            },
